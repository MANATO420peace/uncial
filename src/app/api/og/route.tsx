    ...
    (
      <div style={{ width: '1200px', height: '630px', display: 'flex', flexDirection: 'row', background: '#0d0d0d' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.3)', letterSpacing: '4px', marginTop: '14px', display: 'flex' }}>
            UNIVERSITY CAMPUS
          </div>
        </div>
        {/* 右カラム */}
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'row', gap: '12px', marginTop: '44px' }}>
            <div style={badgeStyle}>掲示板</div>
            <div style={badgeStyle}>フリマ</div>
            <div style={badgeStyle}>時間割</div>
            <div style={badgeStyle}>メッセージ</div>
          </div>
        </div>
      </div>
    ),
